    ...
    <div class="admmenu">
      ...
      <div class="produtosselecionados">
        ...
        <div class="produto">
            ...
            <div class="precoatualproduto">Quantidade Atual</div>
      ...
      if ($result = mysqli_query($conexao, $query)) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            if (isset($_POST['confirmar'.$row["nomeproduto"]])) {
                $queryy = "UPDATE  `bd_mercadinho`.`produto` SET `quantidadeproduto` = '{$_POST['novaqtd'.$row['nomeproduto']]}' WHERE (`nomeproduto` = '{$row['nomeproduto']}');";
          ...
          <div class="produto">
            ...
            <div class="precoatualproduto">'.$row["quantidadeproduto"].'</div>
            <div class="novoprecoproduto">
            <input type="number" id="cartitemsqtdinput" min="0"  step="1" class="cartitemsqtdinput" placeholder="Nova Qtd" name="novaqtd'.$row["nomeproduto"].'">
            </div>
            <div class="confirmaprecoproduto">
